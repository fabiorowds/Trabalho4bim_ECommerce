...
public class ProdutoEndpoint
{
   ...
   {
      TypedQuery<Produto> findByIdQuery = em.createQuery("SELECT DISTINCT p FROM Produto p LEFT JOIN FETCH p.pedidos WHERE p.id = :entityId ORDER BY p.id", Produto.class);
   ...
   {
      TypedQuery<Produto> findAllQuery = em.createQuery("SELECT DISTINCT p FROM Produto p LEFT JOIN FETCH p.pedidos ORDER BY p.id", Produto.class);
